...
\textit{Figures \ref{fig:afm_hki_nataz_height_def_1}} and \textit{\ref{fig:afm_hki_nataz_phase_1}} show height, deflection, and phase shift maps of an 80 x 80 $\mu$m area of sample HKI natural azurite. The surface texture is very dense and shows some small circular particles, shown in the height and phase shift maps. Tip dragging on the surface causes distortions to the image. 
